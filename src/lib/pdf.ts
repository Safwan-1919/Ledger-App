...
<body>
  ...
  <table>
    <thead><tr><th>Date</th><th>Reason</th><th>Type</th><th style="text-align:right">Amount</th></tr></thead>
    <tbody>${rows || '<tr><td colspan="4" style="text-align:center">No transactions</td></tr>'}</tbody>
  </table>
